...
const PROJECTS = [
  /* ---------------------------------------------------------------- AI & Agentic */
  {
    ...
    metric: '30–45 min of intake down to ~5',
    ...
    metrics: [
      { value: '~5 min', label: 'analytics intake, down from 30–45' },
      { value: '2-pass', label: 'keyword + semantic rule retrieval' },
      { value: '1 cmd', label: 'setup for a non-technical PO' }
    ],
    gist: 'Product Owners at a major US airline lost hours to blank work-item forms, un-findable Business Rules, and re-typed analytics intake. PO Copilot turns all of that into one guided conversation — rules-checked, DoR-gated, and nothing reaches the backlog without a human saying so.',
    sections: [
      { kicker: 'the problem', head: 'The Definition of Ready was a document nobody re-read.',
        body: 'Stories arrived at refinement half-formed. Business Rule conflicts surfaced in QA — or in production — instead of during drafting. And every analytics request meant 30 to 45 minutes of re-typing the same forms from scratch.' },
      { kicker: 'what I built', head: 'A conversation, not a form.',
        body: 'A PO brain-dumps in plain English and gets a polished draft back: persona and acceptance criteria enforced as a hard gate, relevant Business Rules cross-checked and cited, analytics documents generated as real files. The AI’s operating rules live as version-controlled markdown, so every PO gets an identical AI and every behaviour change is diffable.',
        pull: 'The system prompt is code, not a setting in a vendor portal.' },
      { kicker: 'the hard part', head: 'Finding a rule you can’t name.',
        body: 'Keyword search only works if you already know the official terminology — exactly the knowledge a newer PO lacks. So I built a second semantic pass: fetch, chunk, embed, index, cosine search over a local SQLite file. Search "letting someone move seats after boarding" and the Seat Change Request rules come back.',
