...
const PROJECTS = [
  /* ---------------------------------------------------------------- AI & Agentic */
  {
    ...
    title: 'PO Copilot',
    initial: 'P',
    kicker: 'Built for me. Adopted by the team.',
    badge: 'Shipped',
    cat: 'ai',
    bg: 'linear-gradient(155deg,#b2622d,#402310)',
    metric: '30–45 min of intake moved ahead of dev',
    blurb: 'A personal AI workflow for writing better PRDs and stories that grew into a tool Product Owners across the company use today.',
    ...
    gist: 'I built PO Copilot to help myself write better Feature PRDs and User Stories and catch edge cases I don\'t always think of alone. It grew, one real problem at a time, into a tool that also generates my analytics intake documents, posts straight to Azure DevOps, and checks drafts against our team\'s Business Rules and Definition of Ready. It\'s now used by Product Owners across the company through the Dojo, the company\'s internal product and technical training program.',
    sections: [
      { kicker: 'the origin', head: 'I wanted the AI to question me, not guess for me.',
        body: 'I write good PRDs, but I don\'t always catch every edge case alone. I didn\'t want AI filling gaps with assumptions, so I built a workflow that interrogates my brain dump instead of the other way around.' },
      { kicker: 'how it grew', head: 'One problem kept leading to the next.',
        body: 'Analytics intake, Azure DevOps posting and platform duplication, Definition of Ready grading, a Business Rules migration into BookStack with real RAG on top. Each piece got added because I hit the next real need, not because I planned it upfront.' },
      { kicker: 'the principles', head: 'AI drafts, I approve, then it posts.',
        body: 'Nothing reaches the backlog without me saying so. I also stayed on our existing Copilot license instead of a new vendor, and kept the build simple on purpose, since adoption depended on it, not on how impressive it looked.',
        pull: 'Something simple that works and proves its value beats something impressive that never gets used.' },
      { kicker: 'the reception', head: 'Adoption was the real signal.',
        body: 'It started with me, then one PO on mobile, then her whole team. Now it\'s rolling out company-wide through the Dojo after catching our CTIO\'s attention.' }
    ],
